...
$rt = $separada['0'];
  ...
  if ($seccion <> "") {
    $consultaSQL = "SELECT B.SECCION, A.ID_SOL,A.HORA, A.FECHA, CONCAT(A.RUT, '-' ,B.DV ) AS RUT, CONCAT(B.NOMBRE, ' ',B.APEPAT, ' ',B.APEMAT) AS FULLNAME   FROM solicitud_alimentacion as A, personal as B WHERE A.RUT=B.RUT AND B.SECCION LIKE '%$seccion%' ";

  } else if ($seccion == ""){
    $consultaSQL = "SELECT B.SECCION, A.ID_SOL,A.HORA, A.FECHA, CONCAT(A.RUT, '-' ,B.DV ) AS RUT, CONCAT(B.NOMBRE, ' ',B.APEPAT, ' ',B.APEMAT) AS FULLNAME   FROM solicitud_alimentacion as A, personal as B WHERE A.RUT=B.RUT";
  }
...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript">  
      ...
      window.open("../production/fpdf/imprimirunidad.php?seccion="+seccion);
    }</script>
  </head>
            ...
            <div class="clearfix"></div>
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                      <a class="btn btn" >
                            ...
                            <h4 class="text-center">X Seccion o unidad</h4>
                           
                               </a>
                             <a href="excelseccion.php?seccion=<?php echo mostrar($seccion);?>">
    ...
    <div class="col-md-12">
      ...
      <form method="post" class="form-inline">
        <div class="form-group mr-3">
          <input type="text" id="seccion" name="seccion" placeholder="Buscar por Seccion" class="form-control-sm"  maxlength="10">
        </div>
          ...
          if ($alumnos && $sentencia->rowCount() > 0) {
            foreach ($alumnos as $fila) {
              ...
              <tr>
                ...
                <td><?php echo mostrar(utf8_encode($fila["FULLNAME"])); ?></td>
