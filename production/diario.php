...
$fecha = $_POST['fecha'];
  ...
  if ($fecha <> "") {
    $consultaSQL = "SELECT B.SECCION, A.ID_SOL,A.HORA, A.FECHA, CONCAT(A.RUT, '-' ,B.DV ) AS RUT, CONCAT(B.NOMBRE, ' ',B.APEPAT, ' ',B.APEMAT) AS FULLNAME   FROM solicitud_alimentacion as A, personal as B WHERE A.RUT=B.RUT and A.FECHA='$fecha'";
  } else{
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <input type="hidden" id="rutt" value="<?php echo mostrar($fecha); ?>">
            ...
            <div class="clearfix"></div>
                    ...
                    <div class="col-md-6 col-sm-6  form-group has-feedback">
                      <a class="btn btn">
                                  ...
                                  <h4 class="text-center">Diario</h4>
                                                                 
                                 </a>
                             <a href="exceldiario.php?fecha=<?php echo mostrar($fecha);?>">
