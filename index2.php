...
try {
  ...
  $consultaSQL = 'SELECT ID_SOL, CONCAT(A.RUT, "-",B.DV)AS RUT, CONCAT(B.NOMBRE, " ", B.APEPAT) AS NOMBRE, A.FECHA, A.SECCION, A.TIPO FROM solicitud_alimentacion AS A, personal AS B WHERE A.RUT = B.RUT order by A.FECHA desc';
        ...
        <tbody>
          ...
          if ($alumnos && $sentencia->rowCount() > 0) {
            foreach ($alumnos as $fila) {
              ...
              ?>
              <tr>
                <td><?php echo mostrar($fila["ID_SOL"]); ?></td>
